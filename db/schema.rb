...
ActiveRecord::Schema[7.0].define(version: 2023_11_09_095224) do
  ...
  create_table "animals", force: :cascade do |t|
    ...
    t.string "name"
    t.integer "age"
    t.boolean "ok_sterilised", default: false
    t.boolean "ok_vaccinated", default: false
    t.string "location"
    t.bigint "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "favourites", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["animal_id"], name: "index_favourites_on_animal_id"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean "has_dog"
    t.boolean "has_cat"
    t.boolean "has_closed_garden"
    t.boolean "has_basket"
    t.boolean "has_kennel"
  ...
  add_foreign_key "favourites", "animals"
